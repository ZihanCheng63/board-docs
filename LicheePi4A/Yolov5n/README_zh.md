...
```bash
# 传输可执行文件
scp /home/licheepi/yolov5n_example debian@172.16.60.217:~/npu_test/

# 传输 hhb_out 目录（包含模型文件）
scp -r /home/licheepi/hhb_out debian@172.16.60.217:~/npu_test/

# 传输测试图片
scp /home/licheepi/kite.jpg debian@172.16.60.217:~/npu_test/
```
运行 NPU 推理程序  
```bash
cd ~/npu_test
chmod +x yolov5n_example
./yolov5n_example ./hhb_out/hhb.bm ./kite.jpg
```
...
```bash
cd ~/npu_test/hhb_out
export LD_LIBRARY_PATH=/home/debian/ort/lib/python3.11/site-packages/shl/install_nn2/th1520/lib:$LD_LIBRARY_PATH
./hhb_runtime ./hhb.bm ../kite.jpg
```
成功后输出：  
```text
Run graph execution time: 18.57649ms, FPS=53.83

=== tensor info ===
shape: 1 3 384 640
data pointer: 0x1073260

=== tensor info ===
shape: 1 255 48 80
data pointer: 0x3fbae2f000
The max_value of output: 3.443873
The min_value of output: -17.471357
The mean_value of output: -5.491803
The std_value of output: 4.574095
 ============ top5: ===========
329636: 3.443873
656036: 3.443873
667150: 3.191882
...
=== tensor info ===
shape: 1 255 24 40
data pointer: 0x3fbadf3000
The max_value of output: 6.665792
The min_value of output: -14.283840
The mean_value of output: -5.499501
The std_value of output: 3.713140
 ============ top5: ===========
168619: 6.665792
168579: 6.232948
168620: 5.973242
...
=== tensor info ===
shape: 1 255 12 20
data pointer: 0x3fbcd7f000
The max_value of output: 5.638581
The min_value of output: -13.231871
The mean_value of output: -6.027710
The std_value of output: 3.766955
 ============ top5: ===========
21749: 5.638581
1349: 5.187495
21769: 5.112314
